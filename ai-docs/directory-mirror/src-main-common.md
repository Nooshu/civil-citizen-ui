...
Shared formatters (dates, URLs, file upload, monthly income/expense calculators, task-list tasks, CYA helpers). Prefer adding a util here over copying logic between services.
