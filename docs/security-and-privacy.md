...
`yarn-audit-known-issues` records **accepted toolchain** advisories (CodeceptJS, Mocha, Sass, Pact, and similar). Do not delete it to “go green” without review, and do not add a production-tree finding there — those must be upgraded instead.
