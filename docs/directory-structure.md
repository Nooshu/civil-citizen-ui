...
- `ui-preview-mappings/` — preview-only stubs for dashboard, admit journeys, case progression, general application, statement of means, court locations, and Ordnance Survey postcode lookup (broader matchers; **must not** be copied into the chart mappings)
