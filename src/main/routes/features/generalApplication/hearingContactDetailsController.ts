...
import {getCancelUrl, getDynamicHeaderForMultipleApplications, saveHearingContactDetails, applicationTypeIndexFromQuery} from 'services/features/generalApplication/generalApplicationService';
